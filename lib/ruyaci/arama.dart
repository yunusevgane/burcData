import '/ruyaci/detay.dart';
import 'package:flutter/material.dart';
import 'dart:convert';
import 'dart:async';
import 'package:flutter/services.dart' as rootBundle;
import '/ruyaci/reklam.dart';
...
class _aramaState extends State<arama> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 0,
        backgroundColor: Color(0xff060831),
      ),
      body: Container(
        color: Color(0xff060934),
        child: Stack(
          children: [
            Container(
                alignment: Alignment.bottomCenter,
                child:
                    Image.asset('assets/ruyaci/home2.png', fit: BoxFit.fill)),
            Container(
            ...
            if (aradetay.length > 1)
              Container(
                margin: EdgeInsets.only(bottom: 0, top: 80, left: 0, right: 0),

...
import '/ruyaalemi/reklam.dart';
import '/ruyaalemi/arama.dart';
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: new AssetImage('assets/ruyaalemi/bg.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(children: [
          ...
          Container(
            margin: EdgeInsets.only(bottom: 0, top: 80, left: 20, right: 20),
